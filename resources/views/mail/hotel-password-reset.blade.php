                            ...
                            <tr>
                                <td style="word-wrap:break-word;font-size:0px;padding:0px 15px 0px 15px;" align="left">
                                    <div style="cursor:auto;color:#000000;font-family:Lato, Tahoma, sans-serif;font-size:11px;line-height:1.5;text-align:left;">
                                        <h1 style="font-family: Arial, sans-serif; line-height: 100%;">Welcome, {{ $hotel['name'] }}</h1>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="word-wrap:break-word;font-size:0px;padding:0px 28px 0px 24px;" align="left">
                                    <div style="cursor:auto;color:#000000;font-family:Lato, Tahoma, sans-serif;font-size:11px;line-height:1.5;text-align:left;">
                                        <h2 style="line-height: 100%;"><span style="font-size:14px;">A password reset request was received for your store account. If this wasn&apos;t you, you can safely ignore this email else if this was requested by you click on the below button to start resetting your password.</span></h2>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="word-wrap:break-word;font-size:0px;padding:20px 20px 20px 20px;" align="center">
                                    <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:separate;width:auto;" align="center" border="0">
                                        <tbody>
                                        <tr>
                                            <td style="background-color: #009688; border:0px solid #000;border-radius:4px;color:#fff;cursor:auto;padding:13px 38px;" align="center" valign="middle" bgcolor="#007bff"><a href="{{ route('hotel.auth.forgot-password.reset-password.form', $hotel['token']) }}" style="text-decoration: none; background: #009688; color: #fff; font-family: Ubuntu, Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif; font-size: 19px; font-weight: normal; line-height: 120%; text-transform: none; margin: 0px;" target="_blank">Click Here To Reset Password</a></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td style="word-wrap:break-word;font-size:0px;padding:0px 24px 0px 25px;" align="left">
                                    <div style="cursor:auto;color:#000000;font-family:Lato, Tahoma, sans-serif;font-size:11px;line-height:1.5;text-align:left;">
                                        ...
                                        <p><span style="font-size:14px;"><a href="{{ route('hotel.auth.forgot-password.reset-password.form', $hotel['token']) }}" style="color: #009688;">{{ route('hotel.auth.forgot-password.reset-password.form', $hotel['token']) }}</a></span></p>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
