...
@section('page-content')
    <div class="main-container container">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <h1 class="text-primary mr-auto">Deleted Store Category</h1>
                </div>
            </div>
        </div>
        <!-- /heading -->
                ...
                @foreach($hotelCategoryList as $item)
                    <tr>
                        ...
                        <td class="align-middle">
                            ...
                            <td class="align-middle">
                                <form method="POST" id="restore-data-form" action="{{ route('admin.hotel-category.deleted.restore', $item->id) }}" hidden>
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}
                                </form>
