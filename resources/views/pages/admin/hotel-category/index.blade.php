...
@section('page-content')
    <div class="main-container container">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <h1 class="text-primary mr-auto">Store Category</h1>
                </div>
                <div class="col align-self-center">
                    <a href="{{ route('admin.hotel-category.create') }}" class="btn btn-outline-primary float-right">Create New</a>
                </div>
            </div>
        </div>
        <!-- /heading -->
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                @if(isset($item->category_image))
                                    <img src="{{ asset('assets/images/hotel-category-images/'.$item->category_image) }}" style="width: 100px; height: 100px;">
                                    @else
                                    &mdash;
                                @endif
                            </td>
                            <td class="align-middle">
                                <a href="{{ route('admin.hotel-category.edit', $item->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</a>
                                <form method="POST" id="delete-data-form" action="{{ route('admin.hotel-category.delete', $item->id) }}" hidden>
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE') }}
                                </form>
