...
@section('page-content')
    <div class="main-container container-fluid">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <h1 class="text-primary mr-auto">All Orders</h1>
                </div>
            </div>
        </div>
        <!-- /heading -->
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                @if($item->order_status == "received")
                                    <button type="button" class="btn btn-primary m-1" id="order-status" data-order-id="{{ $item->id }}" data-order-status="proceeded" data-message="Are you sure you want to mark this order as proceeded?">Proceed with order</button>
                                @elseif($item->order_status == "proceeded")
